"""
CrewAI Cost Estimation Agent with Bedrock Models
"""
...
def main():
    """Test the Bedrock-powered CrewAI estimator"""
    ...
    result = estimator.estimate_costs(materials, MaterialGrade.STANDARD)
    print("💰 Bedrock CrewAI Cost Analysis:")
    print("=" * 50)
